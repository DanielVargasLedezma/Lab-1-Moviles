...
export default {
  computed: {
    ...mapGetters({
      GetUsuarios: "TableCarreraModule/GetUsuarios",
      GetTexto: "TableCarreraModule/GetTexto",
      GET_COLUMNS_TITLE: "TableCarreraModule/GET_COLUMNS_TITLE",

      GET_CANTIDAD_UoC: "TableCarreraModule/GET_CANTIDAD_UoC",
  ...
  methods: {
    ...mapMutations({
      SET_VISIBILIDAD_COLUMNAS: "TableCarreraModule/SET_VISIBILIDAD_COLUMNAS",
      SET_PAGINA_ACTUAL: "TableCarreraModule/SET_PAGINA_ACTUAL",
    }),
