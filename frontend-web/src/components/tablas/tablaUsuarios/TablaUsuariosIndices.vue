...
export default {
  computed: {
    ...mapGetters({
      GetUsuarios: "TableUsuarioModule/GetUsuarios",
      GetTexto: "TableUsuarioModule/GetTexto",
      GET_COLUMNS_TITLE: "TableUsuarioModule/GET_COLUMNS_TITLE",

      GET_CANTIDAD_UoC: "TableUsuarioModule/GET_CANTIDAD_UoC",
  ...
  methods: {
    ...mapMutations({
      SET_VISIBILIDAD_COLUMNAS: "TableUsuarioModule/SET_VISIBILIDAD_COLUMNAS",
      SET_PAGINA_ACTUAL: "TableUsuarioModule/SET_PAGINA_ACTUAL",
    }),
