...
export default {
  computed: {
    ...mapGetters({
      ...
      GET_CANTIDAD_UoC: "TableHistorialModule/GET_CANTIDAD_UoC",
    }),
  ...
  methods: {
    ...mapMutations({
      SET_VISIBILIDAD_COLUMNAS: "TableHistorialModule/SET_VISIBILIDAD_COLUMNAS",
      SET_PAGINA_ACTUAL: "TableHistorialModule/SET_PAGINA_ACTUAL",
    }),
