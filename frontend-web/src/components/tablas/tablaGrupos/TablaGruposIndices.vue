...
export default {
  computed: {
    ...mapGetters({
      GetUsuarios: "TableGrupoModule/GetUsuarios",
      GetTexto: "TableGrupoModule/GetTexto",
      GET_COLUMNS_TITLE: "TableGrupoModule/GET_COLUMNS_TITLE",

      GET_CANTIDAD_UoC: "TableGrupoModule/GET_CANTIDAD_UoC",
  ...
  methods: {
    ...mapMutations({
      SET_VISIBILIDAD_COLUMNAS: "TableGrupoModule/SET_VISIBILIDAD_COLUMNAS",
      SET_PAGINA_ACTUAL: "TableGrupoModule/SET_PAGINA_ACTUAL",
    }),
