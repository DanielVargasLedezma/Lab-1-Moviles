  ...
  <section>
    ...
    >
      <div id="titulo-container">
        <h1 id="titulo">Edición de Cusos</h1>
      </div>
      <div id="addContainer">
        <div id="col1">
          <div>
          ...
          <div>
            <section id="wrapper" class="select">
              ...
              <select
                name="codigo_carrera"
                id="rolCombo"
                v-model="this.GET_CURSO_ACTUAL.carrera.codigo_carrera"
        ...
        <div id="col2">
            ...
            <section id="wrapper">
              ...
              <section id="input-span">
                <select
                  ...
                  :value="curso.num_semestre_a_llevar"
                >
                  <option value="default" selected="Selected" disabled>
                    Seleccionar
                  </option>
          ...
          <div>
            <section id="wrapper">
              <button type="submit" @click="editarCurso">Editar Curso</button>
            </section>
          </div>
        </div>
      </div>
...
export default {
  ...
  async mounted() {
    ...
    this.curso.codigo_curso = this.GET_CURSO_ACTUAL.codigo_curso;
    this.curso.codigo_carrera = this.GET_CURSO_ACTUAL.carrera.codigo_carrera;
    this.curso.nombre = this.GET_CURSO_ACTUAL.nombre;
    this.curso.creditos = this.GET_CURSO_ACTUAL.creditos;
    this.curso.horas_semanales = this.GET_CURSO_ACTUAL.horas_semanales;
    this.curso.num_semestre_a_llevar =
    ...
    async editarCurso() {
      ...
      if (!this.v$.$error) {
        ...
        await cursoController
          .editarCurso(this.curso, this.Token)
          .then((response) => {
            if (response === 204) {
              swal.fire(
                "Curso Editada!",
                "El curso ha sido editada con éxito.",
                "success"
              );
