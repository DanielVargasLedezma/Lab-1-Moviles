  ...
  <section>
    ...
    >
      <div id="titulo-container">
        <h1 id="titulo">Creación de Grupos</h1>
      </div>
      <div id="addContainer">
        <div id="col1">
          <div>
            <section id="wrapper">
              <div id="div-labels">
                <label for="apellido">Número de grupo</label>
              </div>
              <section id="input-span">
                <input
                  ...
                  v-model="grupo.numero_grupo"
                  :class="[{ error: v$.grupo.numero_grupo.$error }]"
                  @input="touchInput"
                  @blur="touchInput"
                />
                <span
              ...
              <span
                ...
                v-if="v$.grupo.numero_grupo.$error"
              >
        ...
        <div id="col2">
          ...
          <div>
            <section id="wrapper">
              ...
              <button type="submit" @click="ingresarGrupo">
                Ingresar Grupo
              </button>
            </section>
          </div>
...
export default {
  ...
  async mounted() {
    ...
    this.grupo.codigo_curso = this.GET_CURSO_ACTUAL.codigo_curso;
    ...
    this.grupo.id_ciclo = this.$refs.select_ciclo.value;
  },
  methods: {
    ...mapMutations({
    ...
    async ingresarGrupo() {
      ...
      if (!this.v$.$error) {
        await grupoController
          .registrarGrupo(this.grupo, this.Token)
          .then((response) => {
            if (response === 201) {
              swal.fire(
                "¡Grupo Registrado!",
