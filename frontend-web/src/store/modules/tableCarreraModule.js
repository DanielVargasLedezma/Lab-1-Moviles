...
const TableCarreraModule = {
  ...
  mutations: {
    ...
    SET_CARRERA_ACTUAL(state, payload) {
      state.carreraActual = payload;
    },
  },
  getters: {
    ...
    GET_CARRERA_ACTUAL: (state) => {
      return state.carreraActual;
    },
  },
};

export default TableCarreraModule;
