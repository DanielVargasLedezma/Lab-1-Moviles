...
const TableCicloModule = {
  ...
  state: {
    ...
    columnas: [true, true, true, true, true, true],
  ...
  mutations: {
    ...
    SET_CICLO_ACTUAL(state, payload) {
      state.cicloActual = payload;
    },
  },
  getters: {
    ...
    GET_CICLO_ACTUAL: (state) => {
      return state.cicloActual;
    },
  },
};

export default TableCicloModule;
