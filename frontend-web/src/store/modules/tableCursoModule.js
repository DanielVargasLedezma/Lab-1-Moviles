...
const TableCursoModule = {
  ...
  state: {
    ...
    columnas: [true, true, true, true, true, true, true, true],
  ...
  mutations: {
    ...
    SET_CURSO_ACTUAL(state, payload) {
      state.cursoActual = payload;
    },
  },
  getters: {
    ...
    GET_CURSO_ACTUAL: (state) => {
      return state.cursoActual;
    },
  },
};

export default TableCursoModule;
