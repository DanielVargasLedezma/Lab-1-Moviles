...
const TableUsuarioModule = {
  ...
  mutations: {
    ...
    SET_USER_ACTUAL(state, payload) {
      state.userActual = payload;
    },
  },
  getters: {
    ...
    GET_USER_ACTUAL: (state) => {
      return state.userActual;
    },
  },
};

export default TableUsuarioModule;
