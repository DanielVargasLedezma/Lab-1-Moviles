...
const TableProfesorModule = {
    ...
    state: {
        ...
        columnas: [true, true, true, true, true],
    ...
    mutations: {
        ...
        SET_PROFESOR_ACTUAL(state, payload) {
            state.profesorActual = payload;
        },
    },
    getters: {
        ...
        GET_PROFESOR_ACTUAL: (state) => {
            return state.profesorActual;
        },
    },
};

export default TableProfesorModule;
