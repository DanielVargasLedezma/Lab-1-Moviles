...
const TableGrupoModule = {
  ...
  mutations: {
    ...
    SET_GRUPO_ACTUAL(state, payload) {
      state.grupoActual = payload;
    },
  },
  getters: {
    ...
    GET_GRUPO_ACTUAL: (state) => {
      return state.grupoActual;
    },
  },
};

export default TableGrupoModule;
